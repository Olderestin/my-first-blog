...
def profile(request, username):
    ...
    if user:
        ...
        posts = Post.objects.filter(author=user.id, published_date__lte=timezone.now()).order_by('published_date')
        return render(request, 'users/profile.html', {'form': form, 'posts': posts})
